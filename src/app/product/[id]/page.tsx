...
import { getPublicProduct } from "@/modules/product/public-api.server";
...
export default async function ProductPage({
    ...
    const buyableOffers = (product.vendorOffers ?? [])
                        ...
                        <>
                            <div className="rounded-xl border border-slate-200 p-3">
                                ...
                                {bestOffer.manageStock ? (
                                    ...
                                    <div className="mt-2 text-xs text-slate-600">موجودی کنترل نمی‌شود</div>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                {buyableOffers.slice(1, 6).map((o) => (
                                    <div key={o.id} className="rounded-xl border border-slate-200 p-3">
                                        ...
                                        <div className="mt-2">
                                            <AddToCartButton productId={product.id} vendorOfferId={o.id} />
                                        </div>
                                    </div>
                                ))}
                            </div>
