        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnglishTitle = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    Slug = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                    WebsiteUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentHtml = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LogoUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Seo_MetaTitle = table.Column<string>(type: "nvarchar(160)", maxLength: 160, nullable: true),
                    Seo_MetaDescription = table.Column<string>(type: "nvarchar(320)", maxLength: 320, nullable: true),
                    Seo_Keywords = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    Seo_CanonicalUrl = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                    Seo_AutoGenerateSnippet = table.Column<bool>(type: "bit", nullable: false),
                    Seo_AutoGenerateHeadTags = table.Column<bool>(type: "bit", nullable: false),
                    Seo_IncludeInSitemap = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReviewHtml = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false),
                    EnableQnA = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    InquiryPhone = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    InquiryMobile = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    VendorCommissionPercent = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: true),
                    HasColorVariants = table.Column<bool>(type: "bit", nullable: false),
                    HasWarranty = table.Column<bool>(type: "bit", nullable: false),
                    GuideHtml = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductContentTabs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductContentTabs_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductContentTabs_ProductId",
