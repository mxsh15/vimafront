...
async function submitQuestion(productId: string, question: string) {
  return apiFetch<{ id: string; status: "pending"; message: string }>(
    "product-questions/submit",
    {
      method: "POST",
...
export default function SubmitQuestionButton({
    ...
    const canSubmit = useMemo(() => questionText.trim().length >= 5, [questionText]);
    ...
    async function handleSubmit() {
        ...
        setError(null);
        try {
            await submitQuestion(productId, questionText.trim());
            setStep("success");
            onSubmitted?.();
        } catch (e: any) {
            setError(e?.message || "ثبت پرسش با خطا مواجه شد.");
        } finally {
            setSubmitting(false);
        }
    }
                    ...
                    {step === "form" ? (
                        <>
                                ...
                                <div className="border-b border-b-[var(--color-neutral-100)] !border-b-4">
                                    <div className="flex items-center px-5 py-3 text-[var(--color-neutral-650)]">
                                        <div className="flex items-center">
                                            ...
                                            <span className="text-h5 mr-1 [font-family:var(--font-iransans)]">
                                                ثبت پرسش
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <div className="flex-1 overflow-y-auto">
                                <div className="p-4 pb-[55px]">
                                  ...
                                  [font-family:var(--font-iransans)]"
                                                                placeholder="پرسش خود را درباره این کالا بنویسید.."
                                                                autoComplete="off"
                                                                value={questionText}
                            ...
                            flex justify-between mb-2"
                                                >
                                                    ...
                                                    <span className="text-xs text-neutral-400 [font-family:var(--font-iransans)]">
                                                        حداقل 5 کاراکتر
                                                    </span>
                                                </div>
                            ...
                            <div className="sticky bottom-0 z-[3] bg-[var(--color-neutral-000)] px-5 py-4 shadow-1-top">
                                ...
                                <div className="text-xs text-neutral-500 [font-family:var(--font-iransans)] text-center mt-5">
                                    ثبت پرسش به معنی موافقت با قوانین انتشار سایت است.
                                </div>
                            </div>
                        </>
                    ) : (
                        ...
                        <div className="h-full flex flex-col">
                            <div className="flex-1 flex flex-col items-center justify-center text-center p-6">
                                ...
                                <div className="text-h4 mt-2 [font-family:var(--font-iransans)]">
                                    {displayName} عزیز! پرسشت ثبت شد!
                                </div>
                                <div className="text-body-2 text-neutral-600 mt-2 max-w-[520px] [font-family:var(--font-iransans)]">
                                    ممکن است کمی زمان ببرد تا پس از بررسی نمایش داده شود.
                                </div>
                            </div>
    ...
    return (
        <>
          ...
          transition-[top] duration-300 ease-in-out h-[40px]"
            >
                <span className="flex items-center justify-center relative grow">ثبت پرسش</span>
            </button>
